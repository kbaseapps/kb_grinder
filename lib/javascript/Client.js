...
function kb_grinder(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.KButil_Build_InSilico_Metagenomes_with_Grinder = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_grinder.KButil_Build_InSilico_Metagenomes_with_Grinder",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_grinder.status",
